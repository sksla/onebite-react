...
// key는 숫자 또는 문자로만 사용가능(단, 예외적으로 띄어쓰기가 있을 시 ""로 감싸는 거 허용)
let person = {
  // key : value
  name: "이정환",
  age: 27,
...
let age = person["age"]; // 괄호표기법 : 접근하고자하는 key를 명시, ""로 꼭 감싸야함(문자열로!!)
console.log(age);
...
// 3.5 프로퍼티의 존재 유무를 확인하는 방법 (in 연산자 : 존재하면 true | 존재 X false 반환)
// "key" in 객체명
